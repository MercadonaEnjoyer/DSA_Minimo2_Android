...
public class Ej1Minimo2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ej1_minimo_2);
        ...
        insigniaListCall.enqueue(new Callback<List<Insignia>>() {
            ...
            public void onResponse(Call<List<Insignia>> call, Response<List<Insignia>> response) {
                if (response.isSuccessful()) {
                    ...
                    recycleadapter adapter = new recycleadapter(Ej1Minimo2Activity.this,objectList);
                    adapter.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            Intent intent = new Intent(Ej1Minimo2Activity.this, DetailEj1Minimo2.class);
